...
# Training uses the C++ headless stat semantics directly:
#   0 = MaxHealth
#   3 = BulletSpeed
#   4 = BulletPenetration
#   5 = BulletDamage
#   6 = Reload
#   7 = MovementSpeed
# Slots 1 and 2 currently have no combat effect in headless training and are
# intentionally de-prioritized here.
PRIMARY_COMBAT_STAT_ORDER = (5, 6, 4, 3, 7, 0)

PRESET_BUILDS = {
    'predator': {
        'display_name': 'Predator',
        'stat_targets': (7, 0, 0, 7, 7, 7, 7, 5),
    ...
    'fighter': {
        ...
        'stat_targets': (7, 0, 0, 7, 7, 7, 7, 7),
        'stat_order': PRIMARY_COMBAT_STAT_ORDER,
        'tank_upgrade_map': {0: (3,), 8: (0,), 9: (1,)},
    },
    'annihilator': {
        'display_name': 'Annihilator',
        'stat_targets': (0, 0, 0, 7, 7, 7, 7, 7),
        'stat_order': PRIMARY_COMBAT_STAT_ORDER,
