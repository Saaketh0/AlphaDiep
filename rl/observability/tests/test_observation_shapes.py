...
from rl.observability.core.observation_schema import COMBAT_GRID_CHANNELS, COMBAT_PREV_ACTION_FIELDS, COMBAT_SELF_FIELDS, VIDEO_GRID_CHANNELS
from rl.env.observations.combat import COMBAT_GRID_CHANNELS as SOURCE_GRID_CHANNELS
from rl.env.observations.combat import COMBAT_PREV_ACTION_FIELDS as SOURCE_PREV_ACTION_FIELDS
from rl.env.observations.combat import COMBAT_SELF_FIELDS as SOURCE_SELF_FIELDS
